...
<head>
    ...
    <title>A melhor loja da cidade</title>
...
<header class="jumbotron my-4 home-banner">
    <div class="container">
        <h1 class="display-3">A melhor loja da cidade!</h1>
        <p class="lead">Porque aqui você pode ser DIVA</p>
        <a href="#" class="btn btn-secondary btn-lg">só hoje!</a>
    </div>
</header>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Melhores maquiagens.</p>
                    </div>
